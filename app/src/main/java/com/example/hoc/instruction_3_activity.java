...
public class instruction_3_activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		b_next_step.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(instruction_3_activity.this, instruction_4_activity.class);
		...
		b_skip.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(instruction_3_activity.this, empty_main_activity.class);
				startActivity(intent);
			}
		});
	}
